...
This mechanism has been integrated into Bitcore-Node-ltcl which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/ltcl-Project/insight-api-ltcl#web-socket-api](https://github.com/ltcl-Project/insight-api-ltcl#web-socket-api) 
* API: [https://github.com/ltcl-Project/insight-api-ltcl#swifttx-transactions](https://github.com/ltcl-Project/insight-api-ltcl#swifttx-transactions) 
...
By default, the ltcl Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the ltcl Core daemon:
