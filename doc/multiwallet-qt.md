...
In order to support loading of multiple wallets in ltcl-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is ltcl.cpp.
...
Changes to ltcl.cpp
----------------------
ltcl.cpp is the entry point into ltcl-qt, and as such, will require some minor modifications to provide hooks for
