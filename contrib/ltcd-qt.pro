...
RESOURCES += src/qt/ltcl.qrc src/qt/ltcl_locale.qrc

TRANSLATIONS += src/qt/locale/ltcl_bg.ts \
                src/qt/locale/ltcl_de.ts \
                src/qt/locale/ltcl_en.ts \
                src/qt/locale/ltcl_es.ts \
                src/qt/locale/ltcl_fi.ts \
                src/qt/locale/ltcl_fr.ts \
                src/qt/locale/ltcl_it.ts \
                src/qt/locale/ltcl_ja.ts \
                src/qt/locale/ltcl_pl.ts \
                src/qt/locale/ltcl_pt.ts \
                src/qt/locale/ltcl_ru.ts \
                src/qt/locale/ltcl_sk.ts \
                src/qt/locale/ltcl_sv.ts \
                src/qt/locale/ltcl_vi.ts \
                src/qt/locale/ltcl_zh_CN.ts \
                src/qt/locale/ltcl_zh_TW.ts
