...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("ltcl Core ltcl-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  ltcl-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded ltcl transaction") + "\n" +
                               "  ltcl-tx [options] -create [commands]   " + _("Create hex-encoded ltcl transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded ltcl transaction
