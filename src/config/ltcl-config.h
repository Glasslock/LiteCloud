/* src/config/ltcl-config.h.  Generated from ltcl-config.h.in by configure.  */
/* src/config/ltcl-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "www.ltcl.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "ltcl Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "ltcl Core 2.3.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "ltcl"
