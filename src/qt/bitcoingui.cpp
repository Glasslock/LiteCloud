                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("ltcl Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a ltcl address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and ltcl: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About ltcl Core"), this);
    aboutAction->setStatusTip(tr("Show information about ltcl Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for ltcl"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your ltcl addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified ltcl addresses"));
    ...
    openAction->setStatusTip(tr("Open a ltcl: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the ltcl Core help message to get a list with possible ltcl command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("ltcl Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to ltcl network", "", count));
}
...
{
    QString strTitle = tr("ltcl Core"); // default title
