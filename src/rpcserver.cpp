...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* ltcl features */
        {"ltcl", "masternode", &masternode, true, true, false},
        {"ltcl", "masternodelist", &masternodelist, true, true, false},
        {"ltcl", "mnbudget", &mnbudget, true, true, false},
        {"ltcl", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"ltcl", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"ltcl", "mnsync", &mnsync, true, true, false},
        {"ltcl", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"ltcl", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use ltcld, or the -server option to ltcl-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> ltcl-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:18652/\n";
}
