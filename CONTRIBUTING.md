Contributing to ltcl Core
============================

The ltcl Core project operates an open contributor model where anyone is
...
The following applies to code changes to the ltcl Core project, and is not to be
confused with overall ltcl Network Protocol consensus changes.

Whether a pull request is merged into ltcl Core rests with the project merge
...
Patches that change ltcl consensus rules are considerably more involved than
...
Where a patch set proposes to change the ltcl consensus, it must have been
...
The project leader is the release manager for each ltcl Core release.
