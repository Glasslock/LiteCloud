...
pkgdatadir = $(datadir)/ltcl
pkgincludedir = $(includedir)/ltcl
pkglibdir = $(libdir)/ltcl
pkglibexecdir = $(libexecdir)/ltcl
...
CONFIG_HEADER = $(top_builddir)/src/config/ltcl-config.h
...
am__DIST_COMMON = $(srcdir)/Makefile.in \
	...
	$(top_srcdir)/src/config/ltcl-config.h.in \
...
ACLOCAL = ${SHELL} /home/chunche/github/LiteCloud/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
AUTOCONF = ${SHELL} /home/chunche/github/LiteCloud/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /home/chunche/github/LiteCloud/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /home/chunche/github/LiteCloud/build-aux/missing automake-1.15
AWK = gawk
BDB_CPPFLAGS = 
...
MAINT = 
MAKEINFO = ${SHELL} /home/chunche/github/LiteCloud/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
...
OTOOL64 = 
PACKAGE = ltcl
PACKAGE_BUGREPORT = www.ltcl.org
PACKAGE_NAME = ltcl Core
PACKAGE_STRING = ltcl Core 2.3.0
PACKAGE_TARNAME = ltcl
PACKAGE_URL = 
...
ZMQ_CFLAGS = 
ZMQ_LIBS = 
abs_builddir = /home/chunche/github/LiteCloud
abs_srcdir = /home/chunche/github/LiteCloud
abs_top_builddir = /home/chunche/github/LiteCloud
abs_top_srcdir = /home/chunche/github/LiteCloud
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /home/chunche/github/LiteCloud/build-aux/install-sh
...
SUBDIRS = src
GZIP_ENV = "-9n"
BITCOIND_BIN = $(top_builddir)/src/ltcld$(EXEEXT)
BITCOIN_QT_BIN = $(top_builddir)/src/qt/ltcl-qt$(EXEEXT)
BITCOIN_CLI_BIN = $(top_builddir)/src/ltcl-cli$(EXEEXT)
...
COVERAGE_INFO = baseline_filtered_combined.info baseline.info block_test.info \
  leveldb_baseline.info test_ltcl_filtered.info total_coverage.info \
  baseline_filtered.info block_test_filtered.info \
  leveldb_baseline_filtered.info test_ltcl_coverage.info test_ltcl.info

OSX_APP_BUILT = $(OSX_APP)/Contents/PkgInfo $(OSX_APP)/Contents/Resources/empty.lproj \
  $(OSX_APP)/Contents/Resources/bitcoin.icns $(OSX_APP)/Contents/Info.plist \
  $(OSX_APP)/Contents/MacOS/ltcl-Qt $(OSX_APP)/Contents/Resources/Base.lproj/InfoPlist.strings
...
src/config/ltcl-config.h: src/config/stamp-h1
	@test -f $@ || rm -f src/config/stamp-h1
	@test -f $@ || $(MAKE) $(AM_MAKEFLAGS) src/config/stamp-h1

src/config/stamp-h1: $(top_srcdir)/src/config/ltcl-config.h.in $(top_builddir)/config.status
	@rm -f src/config/stamp-h1
	cd $(top_builddir) && $(SHELL) ./config.status src/config/ltcl-config.h
$(top_srcdir)/src/config/ltcl-config.h.in:  $(am__configure_deps) 
	($(am__cd) $(top_srcdir) && $(AUTOHEADER))
	rm -f src/config/stamp-h1
	touch $@

distclean-hdr:
	-rm -f src/config/ltcl-config.h src/config/stamp-h1
...
$(OSX_APP)/Contents/MacOS/ltcl-Qt: $(BITCOIN_QT_BIN)
	$(MKDIR_P) $(@D)
...
$(APP_DIST_EXTRAS): $(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/ltcl-Qt
...
$(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/ltcl-Qt: $(OSX_APP_BUILT) $(OSX_PACKAGING)
...
#test_ltcl.info: baseline_filtered_combined.info
#	$(MAKE) -C src/ check
#	$(LCOV) -c -d $(abs_builddir)/src -t test_ltcl -o $@
#	$(LCOV) -z -d $(abs_builddir)/src
#	$(LCOV) -z -d $(abs_builddir)/src/leveldb

#test_ltcl_filtered.info: test_ltcl.info
#	$(LCOV) -r $< "/usr/include/*" -o $@

#block_test.info: test_ltcl_filtered.info
#	$(MKDIR_P) qa/tmp
...
#test_ltcl_coverage.info: baseline_filtered_combined.info test_ltcl_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_ltcl_filtered.info -o $@

#total_coverage.info:  baseline_filtered_combined.info test_ltcl_filtered.info block_test_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_ltcl_filtered.info -a block_test_filtered.info -o $@ | $(GREP) "\%" | $(AWK) '{ print substr($$3,2,50) "/" $$5 }' > coverage_percent.txt

#test_ltcl.coverage/.dirstamp:  test_ltcl_coverage.info
#	$(GENHTML) -s $< -o $(@D)
#	@touch $@
...
#cov: test_ltcl.coverage/.dirstamp total.coverage/.dirstamp

# ltcl: disable the outdated comparison tool test
...
clean-local:
	rm -rf test_ltcl.coverage/ total.coverage/ $(OSX_APP)
